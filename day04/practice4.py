...
car_numbers = ["210어7125", "142가7415", "888호8888", "931나8234"]
usage_minutes = [65, 30, 140, 420]
for i, car_num in enumerate(car_numbers):
    fee = min(((usage_minutes[i] - 30) // 10 * 500) + 1000, 20000)
    print(f'{car_num}: {usage_minutes[i]}분 주차, 최종 요금: {fee}원')
