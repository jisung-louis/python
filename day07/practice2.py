...
print("\n======== 문제1 ========")
eng_sentence = input("영문 문장을 입력하세요 : ")
print(eng_sentence.upper())
print(eng_sentence.lower())

# 문제 2: 공백 제거 및 문자 교체
# 사용자로부터 " Python Programming "과 같이 공백이 포함된 문자열을 입력받아 양쪽 공백을 제거하고, 공백 부분을 언더바(_)로 교체하여 출력하시오.
print("\n======== 문제2 ========")
str2 = input("공백 포함 문자열 입력 : ")
print(str2.strip().replace(" ", "_"))
...
print("\n======== 문제4 ========")
point1 = int(input("첫 번째 점수 입력 : "))
point2 = int(input("두 번째 점수 입력 : "))
print("합격" if point1 >= 50 and point2 >= 50 else "불합격")
...
print("성공" if input_id == db_id and input_pw == db_pw else "실패")
...
print("\n======== 문제7 ========")
idnum = int(input("주민등록번호 뒷자리 첫 번째 숫자 입력 : "))
if idnum in [1, 3]:
    print("남자")
elif idnum in [2, 4]:
    print("여자")
...
print("\n======== 문제12 ========")
p1 = int(input("플레이어1 입력(가위(0), 바위(1), 보(2)) : "))
p2 = int(input("플레이어2 입력(가위(0), 바위(1), 보(2)) : "))
...
print(f"{nickname}님 환영합니다." if nickname == "관리자" else f"{nickname}님 안녕하세요.")